...
twenty_datasets1=("nltcs 1 20" "kdd 2 20" "plants 5 20" "baudio 5 20" "jester 5 20" \
                "bnetflix 2 20" "accidents 1 20" "tretail 5 10" "pumsb_star 2 20" "dna 1 4" \
                "kosarek 5 10" "msweb 7 10")
            
twenty_datasets2=("book 5 10" "tmovie 5 20" "cwebkb 5 20" "cr52 5 20" \
                "c20ng 5 10" "bbc 5 20" "ad 7 1" "msnbc 1 10")
